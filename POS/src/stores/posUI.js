...
export const usePOSUIStore = defineStore("posUI", () => {
	...
	const { isOpen: showInsuranceSerialDialog } = useDialog("insuranceSerial")
	...
	const { isOpen: showAdvancesDialog } = useDialog("advances")
	...
	function resetAllDialogs() {
		...
		showInsuranceSerialDialog.value = false
		...
		showErrorDialog.value = false
		showAdvancesDialog.value = false
		clearError()
	}
